...
export const PAGINATION_SLIDE_LEFT  = 'PAGINATION_SLIDE_LEFT'
export const PAGINATION_SLIDE_RIGHT = 'PAGINATION_SLIDE_RIGHT'
export const PAGINATION_SETTLE      = 'PAGINATION_SETTLE'
