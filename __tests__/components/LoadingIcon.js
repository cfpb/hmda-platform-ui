...
describe('LoadingIcon', () => {
  ...
  it('creates the correct div with class, "LoadingIconWrapper"', () => {
    expect(TestUtils.scryRenderedDOMComponentsWithClass(loadingIcon, 'LoadingIconWrapper').length).toEqual(1)
  })

  it('creates the correct div with class, "LoadingIcon"', () => {
    expect(TestUtils.scryRenderedDOMComponentsWithClass(loadingIcon, 'LoadingIcon').length).toEqual(1)
  })
})
