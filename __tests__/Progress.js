...
describe('progress', function(){
  ...
  it('renders with all props passed', function(){
    expect(p1Node.innerHTML).toEqual('4 of 12 cheers cheered');
  });
  ...
  it('renders with single, explicitly passed', function(){
    expect(p2Node.innerHTML).toEqual('0.24 of 1 cheer cheered');
  });
  ...
  it('renders with single, auto-sliced', function(){
    expect(p3Node.innerHTML).toEqual('0.24 of 1 cheer cheered');
  });
  ...
  it('renders with only required', function(){
    expect(p4Node.innerHTML).toEqual('0 of 3 cheers');
  });
});
