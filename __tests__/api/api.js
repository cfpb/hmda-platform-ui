...
describe('api', () => {
  ...
  it('gets institution', () => {
    ...
    expect(mockedFetch.mock.calls[0][0]).toEqual({pathname: '/institutions/1'})
  })
  ...
  it('creates institutions', () => {
    ...
    expect(mockedFetch.mock.calls[3][0]).toEqual({pathname: '/institutions/1/filings/2/submissions', method: 'POST'})
  })

  it('gets filing', () => {
    api.getFiling('1', '2')
    expect(mockedFetch.mock.calls[4][0]).toEqual({pathname: '/institutions/1/filings/2'})
  })
  ...
  it('gets latest submission', () => {
    ...
    expect(mockedFetch.mock.calls[6][0]).toEqual({suffix: '/submissions/latest'})
  })
  ...
  it('gets edit', () => {
    api.getEdit({edit: '1'})
    expect(mockedFetch.mock.calls[9][0]).toEqual({edit: '1', suffix: '/edits/1'})
  ...
  it('gets csv', () => {
    api.getCSV({})
    expect(mockedFetch.mock.calls[11][0]).toEqual({params: {format: 'csv'}, suffix: '/edits/csv'})

    api.getCSV({suffix: '1'})
    expect(mockedFetch.mock.calls[12][0]).toEqual({params: {format: 'csv'}, suffix: '1'})
  })
  ...
  it('gets irs', () => {
    api.getIRS('1')
    expect(mockedFetch.mock.calls[14][0]).toEqual({submission: '1', suffix: '/irs'})
  })

  it('gets summary', () => {
    api.getSummary('1')
    expect(mockedFetch.mock.calls[15][0]).toEqual({submission: '1', suffix: '/summary'})
  })

  it('gets signature', () => {
    api.getSignature('1')
    expect(mockedFetch.mock.calls[16][0]).toEqual({submission: '1', suffix: '/sign'})
  })

  it('gets parse errors', () => {
    api.getParseErrors('1')
    expect(mockedFetch.mock.calls[17][0]).toEqual({submission: '1', suffix: '/parseErrors'})
  })
