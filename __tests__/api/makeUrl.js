import makeUrl from '../../src/js/api/makeUrl'
...
describe('make url from location object', () => {
  ...
  it('throws without HMDA_ENV', done => {
    ...
    try{
      ...
      expect(e.message).toEqual('No url provided for API, unable to fetch data. This is most likely a build issue.')
      done()
    }
  })
  ...
  it('should respect full pathnames', () => {
    expect(
      makeUrl({pathname: '/argle'})
    ).toEqual('servername/argle')
  })
  ...
  it('should make url from obj', () => {
    ...
    ).toEqual('servername/institutions/id/filings/filing/submissions/submission/suffix?qs')
  })
})
