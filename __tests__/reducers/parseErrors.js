jest.unmock('../../src/js/reducers/parseErrors.js')
import * as types from '../../src/js/constants'
import excludeTypes from './excludeTypes.js'
import parseErrors from '../../src/js/reducers/parseErrors.js'
...
describe('parseErrors reducer', () => {
  ...
  it('handles REFRESH_STATE', () => {
    expect(parseErrors({},{type:'REFRESH_STATE'}))
      .toEqual(defaultParseErrors)
  })

  it('handles RECEIVE_PARSE_ERRORS', () => {
    expect(parseErrors({a:2},{
  ...
  it('shouldn\'t modify state on an unknown action type', () => {
    excludeTypes(types.RECEIVE_PARSE_ERRORS,
      types.REFRESH_STATE, types.REQUEST_PARSE_ERRORS)
      .forEach(v => expect(parseErrors({}, v))
        .toEqual({})
      )
  })
