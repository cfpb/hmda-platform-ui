...
describe('EditsGrouped', function(){
  ...
  it('returns appropriate primary and secondary keys', function(){
    expect(syntactical.getLabel({lar: {loanId: '1'}, edit: 'q1', lars: []})).toEqual('q1');
    expect(syntactical.getSubGroup({lar: {loanId: '1'}, edit: 'q1', lars: []})).toEqual([]);
  });
  ...
  it('returns appropriate primary and secondary keys when grouping by row', function(){
    expect(syntactical2.getLabel({lar: {loanId: '1'}, edits: []})).toEqual('1');
    expect(syntactical2.getSubGroup({lar: {loanId: '1'}, edits: []})).toEqual([]);
  });
});
